...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   비교연산자
        *   비교연산자는 피연산자 사이에서 상대적인 크기를 판단하여 참 혹은 것짓을 반환하는 연산자이다.
        *   연산자 중ㅈ 참 혹은 거짓을 반환하는 연산자는 삼항연산자(세개의 피연산자를 구하는것)의 조건식이나 조건문의 조건절에 많이 사용된다.
        ...
        *   '!='  : 왼쪽의 피연산자와 오른쪽의 피연산자가 다르면 true 다르면 false 를 반환
        *   '>'   : 왼쪽의 피연산자가 오른쪽의 피연산자 보다 크면 true 다르면 false 를 반환
        *   '>='  : 왼쪽의 피연산자가 오른쪽의 피연산자 보다 크거나 같으면 true 다르면 false 를 반환
        *   '<'   : 왼쪽의 피연산자가 오른쪽의 피연산자보다 작으면 같으면 true 다르면 false 를 반환
        *   '<='  : 왼쪽의 피연산자가 오른쪽의 피연산자보다 작거나 같으면 true 다르면 false 를 반환
        * */
        ...
        // 구분선
        System.out.println("inum1이 inum2 보다 큰 지 비교 : " + (inum1 > inum2));
        ...
        System.out.println("ch1 과 ch2가 같지 않은 지 비교 : " + (ch1 != ch2));
        System.out.println("ch1 과 ch2가 큰 지 비교 : " + (ch1 > ch2));
        System.out.println("ch1 과 ch2가 크거나 같은 지 비교 : " + (ch1 >= ch2));
        System.out.println("ch1 과 ch2가 작은지  비교 : " + (ch1 < ch2));
        System.out.println("ch1 과 ch2가 작거나 같은 지 비교 : " + (ch1 <= ch2));
...
//        System.out.println("bool1과 bool2가 같은 지 비교 : " + (bool1 <= bool2));
        ...
        System.out.println("str1 과 str2가 다른지 비교 " + (str1 != str2));
        System.out.println("======================================================");
//        System.out.println("str1 과 str2가 다른지 비교 " + (str1 > str2));
//        System.out.println("str1 과 str2가 다른지 비교 " + (str1 >= str2));
//        System.out.println("str1 과 str2가 다른지 비교 " + (str1 < str2));
